...
<script src="js/bootstrap.min.js"></script>
	...
	<body>
			<nav class="navbar navbar-default navbar-fixed-top" style="background:#F0F8FF">
  <div class="container">
...
<ul class="nav navbar-nav navbar-right">
	  ...
	  <li><a href="http://localhost/nb/Online/Student/web/1.html?q=1"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2><b>'WELCOME Faculty TO OUR ONLINE NOTICE BOARD'</b></h2>
