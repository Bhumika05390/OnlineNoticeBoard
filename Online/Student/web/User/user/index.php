...
<![endif]-->
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="http://localhost/nb/Online/Student/web/1.html?q=1">Logout</a></li>
          </ul>
    ...
    <div class="container-fluid">
      ...
      <li ><a href="index.php?page=notification" class="navigation-links"><i class="fa fa-list-alt mr-2 fa-md" aria-hidden="true"></i>
               Latest Notices</a></li>
               <li class="navigation-items"><a href="http://nexus.rguktong.ac.in/Nexus" class="navigation-links"><i class="fa fa-pencil-square-o mr-2 fa-md" aria-hidden="true"></i>
               Results</a></li>
			...
			<li class="navigation-items"><a href="index.php?page=update_password" class="navigation-links">
               ...
               Update profile</a></li>
               <li class="navigation-items"><a href="index.php?page=update_profile_pic" class="navigation-links"><i class="fa fa-sliders mr-2 fa-md" aria-hidden="true"></i>
               Update profile pic</a></li>

       <li class="navigation-items"><a href="http://localhost/nb/Online/Student/web/1.html?q=1" class="navigation-links active"><i class="fa fa-power-off mr-2 fa-md" aria-hidden="true"></i>
               Logout</a></li>
          </ul>
